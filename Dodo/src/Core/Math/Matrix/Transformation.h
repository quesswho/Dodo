...
namespace Dodo { namespace Math {
    ...
    struct Transformation {
        ...
        Transformation(float posX, float posY, float posZ, float scaleX, float scaleY, float scaleZ, float rotateX,
        ...
        {
            m_Model = Mat4(1.0f);
            m_Model = Mat4::Translate(m_Position) * Mat4::Rotate(m_Rotation.z, Vec3(0.0f, 0.0f, 1.0f)) *
                      Mat4::Rotate(m_Rotation.x, Vec3(1.0f, 0.0f, 0.0f)) *
