...
namespace Dodo { namespace Platform {
    ...
    template <typename T = float> struct CRHMat4x4 {
        ...
        CRHMat4x4(T first, T second, T third, T forth, T fifth, T sixth, T seventh, T eighth, T ninth, T tenth,
        ...
        {
            return CRHMat4x4(2 / (right - left), 0, 0, 0, 0, 2 / (top - bottom), 0, 0, 0, 0, -1, 0,
