...
WorldRenderer::WorldRenderer(Ref<ResourceManager> resourceManager)
...
void WorldRenderer::RenderChunk(Ref<Chunk> chunk, Dodo::RenderAPI& renderAPI)
{
    ...
    renderAPI.SetDrawData({Dodo::Math::Mat4::Translate(Dodo::Math::Vec3((chunk->m_ChunkPos.x << 4), 0, (chunk->m_ChunkPos.y << 4)))});
